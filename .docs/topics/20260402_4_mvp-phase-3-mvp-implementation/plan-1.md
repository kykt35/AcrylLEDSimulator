...
## 前提条件
- 要件の基準は `docs/MVP_milestone.md`、`docs/MVP_PRD.md`、`docs/MVP_UI_Design.md`、`docs/MVP_Tech_Stack.md` を参照する
- 設計の基準は `docs/screen-spec.md`、`docs/component-design.md`、`docs/state-design.md`、`docs/api-spec.md`、`docs/acceptance-criteria.md` を参照する
...
**受け入れ条件:**
- [ ] 現在のプレビューを保存処理へ渡せる
- [ ] `/api/save` の入出力が `docs/api-spec.md` と整合する
...
7. [ ] Phase 3 完了判定が `docs/acceptance-criteria.md` を満たすか確認する
...
- 実装内容が `docs/acceptance-criteria.md` の Must 機能を満たしている
